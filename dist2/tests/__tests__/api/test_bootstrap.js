...
describe(':ContractsApi', function () {
     ...
     */
    test('test host port or network', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // expect(() => {
            //     new LedgerApi('host')
            // }).toThrow(ValidationError)
            expect(function () {
                new api_1.LedgerApi(false, 'port');
            }).toThrow(errors_1.ValidationError);
            expect(function () {
                new api_1.LedgerApi('host', false);
            }).toThrow(errors_1.ValidationError);
            expect(function () {
                new api_1.LedgerApi(false, 1234);
            }).toThrow(errors_1.ValidationError);
            expect(function () {
                new api_1.LedgerApi(false, 1234);
            }).toThrow(errors_1.ValidationError);
            expect(function () {
                new api_1.LedgerApi('host', 1234);
            }).toThrow(errors_1.ValidationError);
            return [2 /*return*/];
        });
    }); });
