        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, api.add_stake(helpers_1.ENTITIES[0], new bn_js_1.BN(1000), new bn_js_1.BN(50))];
                case 1:
                    tx = _a.sent();
    ...
    test('test stake cooldown', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = new api_1.TokenApi(helpers_1.LOCAL_HOST, helpers_1.DEFAULT_PORT);
                    return [4 /*yield*/, api.stake_cooldown(helpers_1.ENTITIES[0])];
                case 1:
                    stake = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    api = new api_1.TokenApi(helpers_1.LOCAL_HOST, helpers_1.DEFAULT_PORT);
                    return [4 /*yield*/, api.deed(helpers_1.ENTITIES[0], deed, null, true)];
                case 1:
                    tx = _a.sent();
                    expect(tx).toBe('68fa027aea39f85b09ef92cfc1cc13ceec706c6aadc0b908b549d2e57d611516');
                    return [2 /*return*/];
    ...
    test('test collect stake', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = new api_1.TokenApi(helpers_1.LOCAL_HOST, helpers_1.DEFAULT_PORT);
                    return [4 /*yield*/, api.collect_stake(helpers_1.ENTITIES[0], 300)];
                case 1:
                    tx = _a.sent();
                    expect(tx).toBe('68fa027aea39f85b09ef92cfc1cc13ceec706c6aadc0b908b549d2e57d611516');
                    return [2 /*return*/];
    ...
    test('test de stake', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = new api_1.TokenApi(helpers_1.LOCAL_HOST, helpers_1.DEFAULT_PORT);
                    return [4 /*yield*/, api.de_stake(helpers_1.ENTITIES[0], 300, 25)];
                case 1:
                    tx = _a.sent();
                    expect(tx).toBe('68fa027aea39f85b09ef92cfc1cc13ceec706c6aadc0b908b549d2e57d611516');
                    return [2 /*return*/];
    ...
    test('test TokenTxFactory transfer', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = new api_1.TokenApi(helpers_1.LOCAL_HOST, helpers_1.DEFAULT_PORT);
                    return [4 /*yield*/, api.transfer(helpers_1.ENTITIES[0], helpers_1.ENTITIES[1], 200, 2)];
                case 1:
                    tx = _a.sent();
