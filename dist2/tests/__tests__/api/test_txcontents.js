...
describe(':TXContentsTest', function () {
    ...
    test('test transfers', function () {
        ...
        var tx_contents = tx_1.TxContents.from_json(data);
        expect(tx_contents.transfers_to(helpers_1.ADDRESSES[0].toHex()).cmp(new bn_js_1.BN(200))).toBe(0);
        expect(tx_contents.transfers_to(helpers_1.ADDRESSES[1].toHex()).cmp(new bn_js_1.BN(300))).toBe(0);
        expect(tx_contents.transfers_to(helpers_1.ADDRESSES[2].toHex()).cmp(new bn_js_1.BN(0))).toBe(0);
    });
});
