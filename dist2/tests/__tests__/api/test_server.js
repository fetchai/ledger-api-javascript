...
describe(':ServerApi', function () {
    ...
    test('test num lanes', function () { return __awaiter(void 0, void 0, void 0, function () {
        var api, num_lanes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, expect(num_lanes).toBe(4)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('test version', function () { return __awaiter(void 0, void 0, void 0, function () {
        var api, version;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
