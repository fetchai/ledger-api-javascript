...
var TokenApi = /** @class */ (function (_super) {
    ...
    function TokenApi(host, port, api) {
        ...
        _this.prefix = utils_1.PREFIX.TOKEN;
        return _this;
    }
    /**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _super.prototype.post_json.call(this, utils_1.ENDPOINT.BALANCE, request, this.prefix)];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _super.prototype.post_json.call(this, utils_1.ENDPOINT.STAKE, request)
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _super.prototype.post_json.call(this, utils_1.ENDPOINT.COOLDOWNSTAKE, request)
                            // check for error cases
                        ];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, _super.prototype.post_tx_json.call(this, encoded_tx, utils_1.ENDPOINT.DEED)];
    ...
    TokenApi.prototype.transfer = function (entity, to, amount, fee, signatories) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        amount = utils_1.convert_number(amount);
                    ...
                    case 1:
                        ...
                        encoded_tx = transaction_1.encode_transaction(tx, signatories);
                        return [4 /*yield*/, this.post_tx_json(encoded_tx, utils_1.ENDPOINT.TRANSFER)];
                    case 2: 
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, _super.prototype.post_tx_json.call(this, encoded_tx, utils_1.ENDPOINT.ADDSTAKE)];
                    case 3: 
                    // submit the transaction
                    return [2 /*return*/, _a.sent()];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        encoded_tx = transaction_1.encode_transaction(tx, [entity]);
                        return [4 /*yield*/, _super.prototype.post_tx_json.call(this, encoded_tx, utils_1.ENDPOINT.DESTAKE)];
                    case 2: 
                    // submit the transaction
                    return [2 /*return*/, _a.sent()];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        encoded_tx = transaction_1.encode_transaction(tx, [entity]);
                        return [4 /*yield*/, _super.prototype.post_tx_json.call(this, encoded_tx, utils_1.ENDPOINT.COLLECTSTAKE)];
                    case 2: 
                    // submit the transaction
                    return [2 /*return*/, _a.sent()];
                }
...
var TokenTxFactory = /** @class */ (function (_super) {
    ...
    TokenTxFactory.deed = function (entity, deed, signatories, allow_no_amend) {
        if (signatories === void 0) { signatories = null; }
        if (allow_no_amend === void 0) { allow_no_amend = false; }
        var tx = common_1.TransactionFactory.create_action_tx(10000, entity, utils_1.ENDPOINT.DEED, utils_1.PREFIX.TOKEN);
        if (signatories !== null) {
    ...
    TokenTxFactory.transfer = function (entity, to, amount, fee, signatories) {
        ...
        tx.from_address(new address_1.Address(entity));
    ...
    TokenTxFactory.add_stake = function (entity, amount, fee, signatories) {
        ...
        fee = utils_1.convert_number(fee);
        amount = utils_1.convert_number(amount);
        var tx = common_1.TransactionFactory.create_action_tx(fee, entity, utils_1.ENDPOINT.ADDSTAKE, 'fetch.token');
        if (signatories !== null) {
            signatories.forEach(function (ent) { return tx.add_signer(ent.public_key_hex()); });
        }
        else {
    ...
    TokenTxFactory.de_stake = function (entity, amount, fee, signatories) {
        ...
        // build up the basic transaction information
        var tx = common_1.TransactionFactory.create_action_tx(fee, entity, utils_1.ENDPOINT.DESTAKE, 'fetch.token');
        if (signatories !== null) {
            signatories.forEach(function (ent) { return tx.add_signer(ent.public_key_hex()); });
        }
        else {
    ...
    TokenTxFactory.collect_stake = function (entity, fee, signatories) {
        ...
        assert_1.default(bn_js_1.BN.isBN(fee));
        // build up the basic transaction information
        var tx = common_1.TransactionFactory.create_action_tx(fee, entity, utils_1.ENDPOINT.COLLECTSTAKE, 'fetch.token');
        if (signatories !== null) {
            signatories.forEach(function (ent) { return tx.add_signer(ent.public_key_hex()); });
        }
        else {
