...
var TokenApi = /** @class */ (function (_super) {
    ...
    TokenApi.prototype.balance = function (address) {
        return __awaiter(this, void 0, bn_js_1.BN, function () {
            var request, _a, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _super.prototype.post_json.call(this, ENDPOINT.BALANCE, request, this.prefix)];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _super.prototype.post_json.call(this, ENDPOINT.STAKE, request)
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _super.prototype.post_json.call(this, ENDPOINT.COOLDOWNSTAKE, request)
                            // check for error cases
                        ];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent()
...
var TokenTxFactory = /** @class */ (function (_super) {
    ...
    TokenTxFactory.deed = function (entity, deed, signatories, allow_no_amend) {
        if (signatories === void 0) { signatories = null; }
        if (allow_no_amend === void 0) { allow_no_amend = false; }
        var tx = common_1.TransactionFactory.create_action_tx(10000, entity, ENDPOINT.DEED, PREFIX.TOKEN);
        if (signatories !== null) {
