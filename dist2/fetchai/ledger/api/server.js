...
var ServerApi = /** @class */ (function (_super) {
    ...
    ServerApi.prototype.status = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.protocol() + "://" + this.host() + ":" + this.port() + "/api/status";
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    ServerApi.prototype.num_lanes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        status = _a.sent();
                        return [2 /*return*/, status.lanes];
                }
            });
        });
    };
    ServerApi.prototype.version = function () {
        return __awaiter(this, void 0, void 0, function () {
            var status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        status = _a.sent();
                        return [2 /*return*/, status.version];
                }
            });
        });
    };
