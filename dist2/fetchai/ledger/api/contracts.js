...
var ContractsApi = /** @class */ (function (_super) {
    ...
    function ContractsApi(host, port, api) {
        ...
        _this.prefix = utils_1.PREFIX.CONTRACT;
        return _this;
    }
    /**
     * Create contract
    ...
    ContractTxFactory.prototype.action = function (contract_address, action, fee, from_address, args, signers, shard_mask) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tx = common_1.TransactionFactory.create_action_tx(fee, from_address, action, utils_1.PREFIX.CONTRACT, shard_mask);
    ...
    ContractTxFactory.prototype.create = function (owner, contract, fee, signers, shard_mask) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tx = common_1.TransactionFactory.create_action_tx(fee, owner, utils_1.ENDPOINT.CREATE, utils_1.PREFIX.CONTRACT, shard_mask);
                        data = JSON.stringify({
