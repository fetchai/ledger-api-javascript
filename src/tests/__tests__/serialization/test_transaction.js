...
describe(':Transaction', () => {
    ...
    it('test simple decode transaction ', () => {
...
it('test contract with 2bit shard mask', () => {
...
it('test contract with 4bit shard mask', () => {
...
it('test contract with large shard mask', () => {
