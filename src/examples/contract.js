...
function transfer(from: Address, to: Address, amount: UInt64)
 printLn("transfer " + toString(from));
 printLn("transfer2 " + toString(to) + " amount : " + toString(amount));
...
async function print_address_balances(api, contract, addresses) {
    ...
    for (let i = 0; i < addresses.length; i++){
        ...
        console.log("BEFORE PRINT ADD BALANCE" + i)
...
async function main(){
    ...
    const contract = new Contract(CONTRACT_TEXT, entity1)
