...
// Re-create an entity from an encrypted JSON object
     ...
     */
    console.log(`The given password ${PASSWORD}${Entity.strong_password(PASSWORD) ? ' is strong enough' : ' is not strong enough'} to be used with our serialization functionality\n`)
...
// Validate that a string is  valid (verify checksum, valid base58-encoding and length)
    console.log(`The Address generated from our entity ${Address.is_address(ADDRESS) ? 'is valid.' : 'is not valid.'}\n`)
